    ...
    return (
        <div className='exercise-container p-4 '>
            ...
            <div className='text-center mt-10'>
                <button onClick={() => handleAddToList(exercise)} className='bg-violet-800 hover:bg-violet-700 px-20 py-3 text-white lg:text-lg sm:text-sm rounded-lg'>Add to List</button>
            </div>
        </div>
    );
};
